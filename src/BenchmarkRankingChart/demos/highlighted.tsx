...
const BenchmarkRankingChartHighlightedDemo: FC = () => {
  ...
  return (
    <StoryBook levaStore={store}>
      <BenchmarkRankingChart data={data} {...props} />
    </StoryBook>
  );
};

BenchmarkRankingChartHighlightedDemo.displayName = 'BenchmarkRankingChartHighlightedDemo';

export default BenchmarkRankingChartHighlightedDemo;
